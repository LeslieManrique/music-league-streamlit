...
st.markdown("""
    <div style="background-color:#9e01c4;padding:1rem 1.5rem;margin-bottom:1.5rem;border-radius:8px">
        <h1 style="color:white;text-align:center;">🎶 Overwatch 3 Waiting Room🎶</h1>
    </div>
""", unsafe_allow_html=True)
...
# Load data
votes = pd.read_csv("exports/season_1/votes.csv")
submissions = pd.read_csv("exports/season_1/submissions.csv")
rounds = pd.read_csv("exports/season_1/rounds.csv")
competitors = pd.read_csv("exports/season_1/competitors.csv")
