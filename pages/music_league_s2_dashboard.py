...
# Load data
votes = pd.read_csv("exports/season_2/votes.csv")
submissions = pd.read_csv("exports/season_2/submissions.csv")
rounds = pd.read_csv("exports/season_2/rounds.csv")
competitors = pd.read_csv("exports/season_2/competitors.csv")
